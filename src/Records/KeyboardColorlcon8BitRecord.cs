...
/// <summary>
/// Represents a keyboard 8 bit icon resource ('kcs8').
/// </summary>
public readonly struct KeyboardColorIcon8BitRecord
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="KeyboardColorIcon8BitRecord"/> struct by parsing binary data.
    /// </summary>
    ...
    public KeyboardColorIcon8BitRecord(ReadOnlySpan<byte> data)
    {
        if (data.Length != Size)
        {
