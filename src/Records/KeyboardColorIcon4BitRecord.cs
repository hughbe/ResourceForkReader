...
/// <summary>
/// Represents a keyboard 4 bit icon resource ('kcs4').
/// </summary>
public readonly struct KeyboardColorIcon4BitRecord
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="KeyboardColorIcon4BitRecord"/> struct by parsing binary data.
    /// </summary>
    ...
    public KeyboardColorIcon4BitRecord(ReadOnlySpan<byte> data)
    {
        if (data.Length != Size)
        {
